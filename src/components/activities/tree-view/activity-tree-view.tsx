...
import { GET_ACTIVITIES_TREE_VIEW_CREQ } from "@/utils/erp-requests/clients-reqs/activity-reqs";
...
export default function ActivityTreeView() {
  ...
  const fetchData = async () => {
    const res = await CLIENT_COLLECTOR_REQ(GET_ACTIVITIES_TREE_VIEW_CREQ)
