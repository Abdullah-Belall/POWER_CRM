    ...
    subItems: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { name: "Cash at Bank", path: "/general-ladger/acc/inputs/cash-at-bank", roles: ['general-ladger'] },
          { name: "Cash in Hand", path: "/general-ladger/acc/inputs/cash-in-hand", roles: ['general-ladger'] },
          { name: "Expensess", path: "/general-ladger/acc/inputs/expensess", roles: ['general-ladger'] },
          { name: "Revenue", path: "/general-ladger/acc/inputs/revenue", roles: ['general-ladger'] },
          { name: "Assits", path: "/general-ladger/acc/inputs/assits", roles: ['general-ladger'] },
          { name: "Personal Covenant", path: "/general-ladger/acc/inputs/personal_covenant", roles: ['general-ladger'] },
          { name: "Depts Accounts", path: "/general-ladger/acc/inputs/depts-accounts", roles: ['general-ladger'] },
          { name: "Credit Accounts", path: "/general-ladger/acc/inputs/credit-accounts", roles: ['general-ladger'] },
        ],
      },
      {
        name: "Transactions",
        roles: ['general-ladger'],
        subItems: [
          { name: "General Journal", path: "/general-ledger/transactions/general-journal", roles: ['general-ladger'] },
          { name: "Cash Receit Vouchers", path: "/general-ledger/transactions/cash-receit-vouchers", roles: ['general-ladger'] },
          { name: "Bank Receit Vouchers", path: "/general-ledger/transactions/bank-receit-vouchers", roles: ['general-ladger'] },
          { name: "Cash Payment Vouchers", path: "/general-ledger/transactions/cash-payment-vouchers", roles: ['general-ladger'] },
          { name: "Bank Payment Vouchers", path: "/general-ledger/transactions/bank-payment-vouchers", roles: ['general-ladger'] },
        ],
      },
      {
