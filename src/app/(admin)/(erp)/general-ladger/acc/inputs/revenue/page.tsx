...
import RevenueFundsTable from "@/components/tables/erp/funds/revenue-funds-table"
...
export default function Revenue() {
  ...
  const fetchData = async () => {
    const res = await CLIENT_COLLECTOR_REQ(GET_FUNDS_CREQ, {type: AccAnalyticEnum.INCOME});
    if(res.done) {
      dispatch(fillTable({
        tableName: 'revenueFundsTable',
        obj: {
          data: res.data.funds,
  ...
  return (
    <>
      ...
      <FundFormPopup acc_analy_type={AccAnalyticEnum.INCOME} tableName={'revenueFundsTable'} />
