...
import PersonalCovenantFundsTable from "@/components/tables/erp/funds/personal-covenant-funds-table"
...
export default function PersonalCovenant() {
  const dispatch = useAppDispatch()
  const fetchData = async () => {
    const res = await CLIENT_COLLECTOR_REQ(GET_FUNDS_CREQ, {type: 'Personal Covenant'});
    if(res.done) {
      dispatch(fillTable({
        tableName: 'personalCovenantFundsTable',
        obj: {
          data: res.data.funds,
  ...
  return (
    <>
      ...
      <FundFormPopup acc_analy_type={'Personal Covenant' as any} tableName={'personalCovenantFundsTable'} />
